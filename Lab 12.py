...
def deposit(depAmount):
    ...
    if userChoice == "c":
        ...
        print(depAmount, "dollars has been deposited into Checking.")
    elif userChoice == "s":
        currBalance = int(account_info[3])
        newBalance = currBalance + depAmount
        account_info[3] = str(newBalance)
        print(depAmount, "dollars has been deposited into Savings.")
    else:
...
def withdraw(wAmount):
    ...
    if userChoice == "c":
        ...
        if currBalance >= wAmount:
            ...
            account_info[2] = str(newBalance)
            print(wAmount, "dollars has been withdrawn from Checking.")
        else:
        ...
        if currBalance >= wAmount:
            newBalance = currBalance - wAmount
            account_info[3] = str(newBalance)
            print(wAmount, "dollars has been withdrawn from Savings.")
        else:
            print("Insufficient Funds")
    else:
